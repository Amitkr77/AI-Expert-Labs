  ...
  return (
    <section className="hero" id="hero">
      <div className="slider-wrapper">
        ...
        <button className="slider-btn slider-btn-prev" onClick={goPrev} aria-label="Previous slide">
          <svg viewBox="0 0 24 24" fill="none"><polyline points="15 18 9 12 15 6"/></svg>
        </button>

        <button className="slider-btn slider-btn-next" onClick={goNext} aria-label="Next slide">
