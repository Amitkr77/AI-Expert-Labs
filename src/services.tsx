...
>
  View Portfolio →
    ...
    {/* STATS */}
   {/* STATS */}
<div className="max-w-6xl mx-auto mt-10 border-y border-white/10">

  <div className="grid grid-cols-2 md:grid-cols-5">

    {/* ITEM */}
    <div className="p-6 border-r border-white/10 flex flex-col items-center justify-center text-center">
    ...
    <div className="p-6 border-r border-white/10 flex flex-col items-center justify-center text-center">
      <p className="text-4xl md:text-5xl font-bold text-pink-400 mb-2">50+</p>
      <p className="text-white/60 text-xs font-semibold uppercase tracking-widest">
        Industries
      </p>
    </div>
    ...
    <div className="p-6 border-r border-white/10 flex flex-col items-center justify-center text-center">
      <p className="text-4xl md:text-5xl font-bold text-purple-400 mb-2">200+</p>
      <p className="text-white/60 text-xs font-semibold uppercase tracking-widest">
        Clients
      </p>
    </div>
    ...
    <div className="p-6 border-r border-white/10 flex flex-col items-center justify-center text-center">
      <p className="text-4xl md:text-5xl font-bold text-cyan-400 mb-2">150+</p>
      <p className="text-white/60 text-xs font-semibold uppercase tracking-widest">
        Automations
      </p>
    </div>
    ...
    <div className="p-6 flex flex-col items-center justify-center text-center">
      <p className="text-4xl md:text-5xl font-bold text-green-400 mb-2">100%</p>
      <p className="text-white/60 text-xs font-semibold uppercase tracking-widest">
        Client Satisfaction
      </p>
    </div>
...
<div className="max-w-7xl mx-auto px-6 mt-20">
  ...
  <div className="text-center mb-12">
    ...
    <p className="text-slate-500 mt-3 max-w-xl mx-auto text-xl">
 ...
 <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
  ...
  {servicesData.map((service, i) => {
    ...
    const gradients = [
      "hover:from-orange-500 hover:via-amber-500 hover:to-yellow-400",
      "hover:from-blue-600 hover:via-cyan-500 hover:to-sky-400",
      "hover:from-purple-600 hover:via-pink-500 hover:to-rose-400",
      "hover:from-emerald-600 hover:via-green-500 hover:to-lime-400",
      "hover:from-indigo-600 hover:via-violet-500 hover:to-purple-400",
      "hover:from-teal-600 hover:via-cyan-500 hover:to-blue-400"
    ];

    const glows = [
      "from-orange-500/30 to-yellow-400/30",
      "from-blue-500/30 to-cyan-400/30",
      "from-purple-500/30 to-pink-400/30",
      "from-emerald-500/30 to-lime-400/30",
      "from-indigo-500/30 to-purple-400/30",
      "from-teal-500/30 to-blue-400/30"
    ];
    ...
    return (
      <div
        ...
        hover:bg-gradient-to-br ${gradients[i % gradients.length]}
      ...
      >
        ...
        bg-gradient-to-r ${glows[i % glows.length]}
  ...
  {[
    {
      ...
      gradient: "hover:from-orange-500 hover:via-amber-500 hover:to-yellow-400",
      glow: "from-orange-500/30 to-yellow-400/30"
    },
    {
      step: "02",
      title: "Infrastructure",
      desc: "Secure, scalable vector databases and enterprise-grade LLM pipelines.",
      gradient: "hover:from-blue-600 hover:via-cyan-500 hover:to-sky-400",
    ...
    },
    {
      ...
      gradient: "hover:from-purple-600 hover:via-pink-500 hover:to-rose-400",
      glow: "from-purple-500/30 to-pink-400/30"
    },
    {
      step: "04",
      title: "Autonomous Scale",
      desc: "Multi-agent systems orchestrating complex workflows.",
      gradient: "hover:from-emerald-600 hover:via-green-500 hover:to-lime-400",
      glow: "from-emerald-500/30 to-lime-400/30"
    },
  ].map((item, i) => (
    <div
      key={i}
  ...
  {[
    ...
    >
      ...
      <div className="relative z-10">
        ...
        bg-gradient-to-r from-slate-800 to-slate-600 text-white font-bold text-lg mb-6 shadow-md
      ...
      {/* CTA */}
      <div className="max-w-4xl mx-auto px-3 mt-16 mb-0 text-center bg-gradient-to-r from-orange-500 to-pink-500 rounded-3xl py-4 text-white shadow-xl">

        <h2 className="text-3xl md:text-4xl font-bold mb-9">
          Ready to Build Your 𝑨𝑰 𝑺𝒐𝒍𝒖𝒕𝒊𝒐𝒏?
        </h2>
